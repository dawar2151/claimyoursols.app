...
export const metadata: Metadata = {
  ...
  description:
    "Close unused SPL token accounts with zero balance and recover rent deposits (0.00204 SOL per account). Safe and simple - only affects empty accounts on Solana blockchain.",
  keywords:
