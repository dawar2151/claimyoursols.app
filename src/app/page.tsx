          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            <div className="text-center mb-8">
              ...
              >
                ...
                accounts, even after you&apos;ve sold your tokens. Close those
                unused token accounts and Claim your sol rent fees safely and
                securely.
              </p>
            </div>
            ...
            >
              ...
              <p
                ...
                style={{ color: colors.text.secondary }}
              >
                This tool is completely open source. You can review the code,
