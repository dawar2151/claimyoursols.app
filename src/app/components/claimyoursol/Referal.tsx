...
const Referral: React.FC<ReferralProps> = () => {
    ...
    return (
        <div
            className="my-12 mx-auto max-w-2xl p-6 rounded-2xl shadow-xl transition-all duration-500 hover:shadow-2xl"
        ...
        >
            ...
            >
                ...
                for every successful referral! Share your unique link below and start boosting your rewards today!
            </p>
            <QRCodeCanvas
                value={referralLink}
                size={128}
