        ...
        >
            ...
            >
                ...
                <div className="mt-8 pt-6 border-t" style={{ borderColor: `${colors.border}/50` }}>
                    ...
                    >
                        {isClosing ? "Closing Accounts..." : `Burn & Close Accounts & Get SOL Back (${selectedAccounts.size})`}
                    </XButton>
                    <XTypography variant="body" className="text-xs mt-3 text-center" style={{ color: colors.text.secondary }}>
                        This will close selected accounts and refund your locked SOL back to your wallet
                    </XTypography>
