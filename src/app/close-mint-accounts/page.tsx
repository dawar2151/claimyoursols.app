...
export const metadata: Metadata = {
  ...
  description:
    "Close Token2022 mint accounts you created and recover their rent deposits. Automatically burns remaining tokens if only from close authority account on Solana.",
  keywords:
