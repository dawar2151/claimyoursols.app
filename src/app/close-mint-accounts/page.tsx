...
export const metadata: Metadata = {
  title: "Close Mint Accounts (Token2022)",
  description:
  ...
  openGraph: {
    ...
    description:
      "Safely close Token2022 mint accounts you created and recover rent deposits (0.0048 SOL per account). Automatically burns remaining tokens if only from the close authority account.",
    url: "https://www.claimyoursols.app/close-mint-accounts",
    images: [
      {
        url: "https://www.claimyoursols.app/images/close-mint-account.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://www.claimyoursols.app/images/close-mint-account.png"],
  },
  alternates: {
    canonical: "https://www.claimyoursols.app/close-mint-accounts",
  },
};
